context("to_epocktime")

test_that("to_epocktime with numeric works", {
  expect_equal(to_epochtime(1496587909), 1496587909L)
  expect_equal(to_epochtime(1496587909L), 1496587909L)
})

test_that("to_epocktime with POSIXct and POSIXlt works", {
...
test_that("to_epocktime with Date works", {
  x <- as.Date("2017-06-04", "%Y-%m-%d", tz = "UTC")
  expect_equal(to_epochtime(x), 1496534400L)
})

test_that("to_epocktime with character works", {
  x <- "2017-06-04"
...
test_that("to_epocktime with NULL throws error", {
  expect_error(to_epochtime(NULL))
})

test_that("to_epocktime with elements more than 1 length throws error", {
